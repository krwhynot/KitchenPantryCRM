<div>
    ...
    <x-table-wrapper :headers="['Priority', 'Organization', 'Segment', 'Distributor', 'Account Manager', 'Last Contact', 'Actions']">
        @forelse($organizations as $organization)
            <div class="px-6 py-4 grid grid-cols-7 gap-4 items-center hover:bg-gray-50">
                ...
                <div class="text-sm text-gray-900">{{ $organization->distributor }}</div>
                <div class="text-sm text-gray-900">{{ $organization->account_manager }}</div>
                <div class="text-sm text-gray-900">{{ $organization->last_contact_formatted }}</div>
                <div>
